//SETTING UP SVG CANVAS AND DIMENSIONS
...
//TO STORE CLUSTER CENTROIDS AND DATA POINTS
var clusters = [], points = [];
...
function make() {
  ...
  centroidUpdate(c.enter()
    .append('path')
    .attr('d', d3.svg.symbol().type('triangle-down').size(300))
    .attr('stroke', '#aabbcc'));
  centroidUpdate(c
    .transition()
    .duration(500));}
